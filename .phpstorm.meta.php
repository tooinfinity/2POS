...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\TouwfiQ\github\2POS\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\TouwfiQ\\github\\2POS\\public\\storage','logging.default','logging.deprecations.channel',
...
'signed','throttle','verified','locale','role',
...
'language','language.update','users.index','users.create','users.store',
'users.show','users.edit','users.update','users.destroy','appearance',
...
'auth.failed','auth.password','auth.throttle','auth.Email address','auth.Forgot password?',
'auth.Log in','auth.Enter your email and password below to log in','auth.Log in to your account','auth.Don\'t have an account?','auth.The provided password is incorrect.',
'auth.Password','auth.Remember me','auth.Sign up','pagination.previous','pagination.next',
...
'validation.uuid','validation.custom.attribute-name.rule-name','ar.0','dashboard.Dashboard','dashboard.Profile',
'dashboard.Profile settings','dashboard.Profile information','dashboard.Update your account\'s profile information and email address.','dashboard.Name','dashboard.Email address',
'dashboard.Save','dashboard.Delete your account and all of its resources','dashboard.Warning','dashboard.Please proceed with caution, this cannot be undone.','dashboard.Delete account',
'dashboard.Password','dashboard.Password settings','dashboard.Update password','dashboard.Ensure your account is using a long, random password to stay secure','dashboard.Current password',
'dashboard.New password','dashboard.Confirm password','dashboard.Save password','dashboard.Appearance','dashboard.Appearance settings',
'dashboard.Update your account appearance settings','dashboard.Light','dashboard.Dark','dashboard.System','dashboard.Language',
'dashboard.Language settings','dashboard.Language preferences','dashboard.Choose your preferred language for the application interface','dashboard.Select Language','dashboard.English',
'dashboard.French','dashboard.Arabic','dashboard.Settings','dashboard.Manage your profile and account settings','dashboard.Are you sure you want to delete your account?',
'dashboard.Once your account is deleted, all of its resources and data will also be permanently deleted. Please enter your password to confirm you would like to permanently delete your account.','dashboard.Cancel','dashboard.Log out','en.0','fr.0',);
