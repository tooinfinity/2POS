...
export default function DeleteUser() {
    ...
    return (
        <div className="space-y-6">
            <HeadingSmall title={__('Delete account')} description={__('Delete your account and all of its resources')} />
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                <div className="relative space-y-0.5 text-red-600 dark:text-red-100">
                    <p className="font-medium">{__('Warning')}</p>
                    <p className="text-sm">{__('Please proceed with caution, this cannot be undone.')}</p>
                </div>
